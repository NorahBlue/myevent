...
static function addMenus() {
    ...
    add_submenu_page (
        ...
        __( 'event_types', 'my-event-types' ),
         
        // string $menu_title The text to be used for the menu
        __( 'Event types',  'my-event-types'),
        ...
        // callback $function The function to be called to output the content for this page.
        array( 'MyEventOrganiser_AdminController', 'adminSubMenuEventtype' )
        ); 
...
static function adminSubMenuEventtype() {
